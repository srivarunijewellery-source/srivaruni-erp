        ...
        <CardBody className="space-y-3">
          <div>
            ...
            <p className="mt-0.5 text-sm text-text-muted">
              ...
              {transfer.lines.length} {transfer.lines.length === 1 ? "item" : "items"}. Take a
              phone or tablet to the rail and scan each tag as it goes in the box.
            </p>
          </div>
        ...
        <CardBody className="space-y-3">
          {complete ? (
            <p className="text-sm text-status-done-fg">
              Everything requested is in the box.
            </p>
          ) : (
            <>
              <p className="text-sm">
