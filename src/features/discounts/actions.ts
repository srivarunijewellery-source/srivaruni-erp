...
const settingsSchema = z.object({
  ...
  exclusiveBenefits: z.coerce.boolean(),
  stackGifts: z.coerce.boolean(),
  autoApplySchemes: z.coerce.boolean(),
...
export async function saveDiscountSettings(input: unknown): Promise<Result> {
  ...
  const { error } = await supabase
    ...
    .update({
      ...
      exclusive_benefits: v.exclusiveBenefits,
      stack_gifts: v.stackGifts,
      auto_apply_schemes: v.autoApplySchemes,
